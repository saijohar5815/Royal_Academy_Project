import { useNavigate } from 'react-router-dom'; // 🌟 Import navigation engine
...
import { 
  ...
  Trophy, 
  Tv 
} from 'lucide-react'; // 🌟 Imported all specific facility data icons

// --- FACILITIES DATA MATRIX ---
const facilities = [
  {
...
function Facilities() {
  const navigate = useNavigate(); // 🌟 Initialize router navigator

  return (
    <section
      id="facilities"
      className="py-16 sm:py-24 md:py-28 bg-gradient-to-b from-white via-slate-50 to-white overflow-hidden font-sans"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                >
                  <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-100 p-6 sm:p-10 shadow-lg shadow-slate-100/80">
                    ...
                    <button 
                      ...
                      className="group mt-8 sm:mt-10 w-full sm:w-auto bg-blue-900 hover:bg-blue-950 text-white font-semibold text-sm px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl flex items-center justify-center gap-2.5 transition-all duration-300 shadow-lg shadow-blue-900/10 active:scale-[0.98]"
                    >
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <button 
              type="button"
              onClick={() => navigate('/campus-visit')} // 🌟 Direct navigation linkage
              className="mt-8 sm:mt-10 w-full sm:w-auto bg-amber-400 hover:bg-amber-500 text-slate-950 font-bold text-sm px-8 sm:px-10 py-3.5 sm:py-4 rounded-xl transition-all duration-300 shadow-xl shadow-amber-400/10 active:scale-[0.98]"
            >
