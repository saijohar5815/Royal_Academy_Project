...
export default function AdmissionsCTA() {
  ...
  return (
    <section
      id="admissions"
      className="py-12 sm:py-20 lg:py-24 bg-[#060913] text-white relative overflow-hidden"
    >
      {/* Background */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed sm:leading-8">
            Secure a seat in our upcoming cohort. Applications are evaluated
            dynamically on a rolling timeline. Give your child access to elite
            global metrics today.
          </p>
