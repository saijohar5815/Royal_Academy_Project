...
const VIDEO_DATA = [
  {
    id: 1,
    thumbnail: "https://res.cloudinary.com/digicomm/image/upload/t_metadata/news-magazine/_assets/images/placeholder.jpg",
    videoUrl: "/videos/gallery-video.mp4" 
  },
  {
    id: 2,
    thumbnail: "https://rbia.in/wp-content/uploads/2024/09/Campus-Facilities-Img.webp",
    videoUrl: "/videos/gallery-video-1.mp4"
  }
];
    ...
    <section className="space-y-6 sm:space-y-8">
      ...
      {VIDEO_DATA.map((item) => {
        ...
        return (
          <div
            key={item.id}
            className="group relative rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-200 bg-black aspect-video shadow-sm hover:shadow-xl transition-all duration-300"
          >
            {isPlaying ? (
              /* 3. If playing, render the native video element elements */
              <video
                src={item.videoUrl}
                controls
                autoPlay
              ...
              /* 4. Otherwise, show your clean custom thumbnail overlay wrapper UI */
              <>
                <img
                  src={item.thumbnail}
                  alt="Video Thumbnail"
